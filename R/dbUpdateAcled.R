...
#'
#' @param con A database connection object created with \code{\link[DBI]{dbConnect}}
...
#' )
#' }
dbUpdateAcled <- function(con, acled.new.df) {

  # Validate inputs
  if (!DBI::dbIsValid(dbObj = con)) {
